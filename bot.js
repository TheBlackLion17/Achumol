...
async function whatsAsena () {
    ...
    setInterval(async () => { 
        ...
        await axios.get('https://gist.githubusercontent.com/TheBlackLion17/b033bb0699e32d214e6a5c3a3648405e/raw').then(async (ann) => {
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [Achumol] --*' + 
                                    '\n*Achumol an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [Achumol] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
